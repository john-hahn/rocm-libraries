...
{
    PointwiseSignatureKey key1{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key2{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    EXPECT_TRUE(key1 == key2);

    PointwiseSignatureKey key3{
        PointwiseMode::RELU_FWD, DataType::HALF, DataType::FLOAT, DataType::HALF};
    PointwiseSignatureKey key4{
        PointwiseMode::RELU_FWD, DataType::HALF, DataType::FLOAT, DataType::HALF};
    EXPECT_TRUE(key3 == key4);

    // Different operations
    PointwiseSignatureKey key5{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key6{
        PointwiseMode::SUB, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    EXPECT_FALSE(key5 == key6);

    // Different input data types
    PointwiseSignatureKey key7{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key8{PointwiseMode::ADD, DataType::HALF, DataType::FLOAT, DataType::HALF};
    EXPECT_FALSE(key7 == key8);

    // Different output data types
    PointwiseSignatureKey key9{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key10{
...
TEST(TestPointwiseSignatureKey, HashFunction)
{
    ...
    PointwiseSignatureKey key3{PointwiseMode::SUB, DataType::HALF, DataType::FLOAT, DataType::HALF};
    PointwiseSignatureKey key4{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::HALF};
...
{
    PointwiseSignatureKey original{
...
TEST(TestPointwiseSignatureKey, UnorderedMapUsage)
{
    ...
    PointwiseSignatureKey key2{
        PointwiseMode::SUB, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key3{PointwiseMode::ADD, DataType::HALF, DataType::FLOAT, DataType::HALF};
    ...
    PointwiseSignatureKey key1Copy{
        PointwiseMode::ADD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
...
TEST(TestPointwiseSignatureKey, UnorderedSetUsage)
{
    ...
    PointwiseSignatureKey key2{
        PointwiseMode::SIGMOID_FWD, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};
    PointwiseSignatureKey key3{PointwiseMode::RELU_FWD,
                               DataType::FLOAT,
                               DataType::FLOAT,
...
TEST(TestPointwiseSignatureKey, DifferentOperationsAreDifferent)
{
    ...
    for(size_t i = 0; i < unaryModesBitset.size(); ++i)
    {
        if(unaryModesBitset.test(i))
        {
            ...
            PointwiseSignatureKey key{op, DataType::FLOAT, DataType::FLOAT, DataType::FLOAT};

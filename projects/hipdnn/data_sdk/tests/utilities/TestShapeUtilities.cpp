...
protected:
    ...
    void SetUp() override
    {
        // Enable capture of logs generated by the function under test.
        sCapturedLogs.clear();
    ...
    {
        // Clear the callback and reset logging state
        hipdnn_data_sdk::logging::resetLogging();
    }

    static std::vector<std::string> getCapturedLogs()
    {
        return sCapturedLogs;
    }
    ...
    static void testLoggingCallback([[maybe_unused]] hipdnnSeverity_t severity, const char* msg)
    {
        ...
        if(msg != nullptr)
        {
            sCapturedLogs.emplace_back(msg);
        }
    }
};

std::vector<std::string> TestShapeUtilsExtractStrideOrder::sCapturedLogs;
std::mutex TestShapeUtilsExtractStrideOrder::sLogMutex;

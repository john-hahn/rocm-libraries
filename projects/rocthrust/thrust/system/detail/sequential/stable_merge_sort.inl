...
THRUST_HOST_DEVICE void inplace_merge(
...
THRUST_HOST_DEVICE void inplace_merge_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
...
THRUST_HOST_DEVICE void insertion_sort_each_by_key(
...
template <typename DerivedPolicy,
          ...
          typename RandomAccessIterator2,
          typename StrictWeakOrdering>
THRUST_HOST_DEVICE void merge_adjacent_partitions(
  sequential::execution_policy<DerivedPolicy>& exec,
...
template <typename DerivedPolicy,
          ...
          typename StrictWeakOrdering>
THRUST_HOST_DEVICE void merge_adjacent_partitions_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 keys_first,
  RandomAccessIterator1 keys_last,
  RandomAccessIterator2 values_first,
...
template <typename DerivedPolicy, typename RandomAccessIterator, typename StrictWeakOrdering>
THRUST_HOST_DEVICE void iterative_stable_merge_sort(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator first,
  RandomAccessIterator last,
  StrictWeakOrdering comp)
...
template <typename DerivedPolicy,
          ...
          typename RandomAccessIterator2,
          typename StrictWeakOrdering>
THRUST_HOST_DEVICE void iterative_stable_merge_sort_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 keys_first,
  RandomAccessIterator1 keys_last,
  RandomAccessIterator2 values_first,
...
template <typename DerivedPolicy, typename RandomAccessIterator, typename StrictWeakOrdering>
THRUST_HOST_DEVICE void recursive_stable_merge_sort(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator first,
  RandomAccessIterator last,
  StrictWeakOrdering comp)
...
template <typename DerivedPolicy,
          ...
          typename RandomAccessIterator2,
          typename StrictWeakOrdering>
THRUST_HOST_DEVICE void recursive_stable_merge_sort_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 first1,
  RandomAccessIterator1 last1,
  RandomAccessIterator2 first2,
...
template <typename DerivedPolicy, typename RandomAccessIterator, typename StrictWeakOrdering>
THRUST_HOST_DEVICE void stable_merge_sort(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator first,
  RandomAccessIterator last,
  StrictWeakOrdering comp)
...
template <typename DerivedPolicy,
          ...
          typename RandomAccessIterator2,
          typename StrictWeakOrdering>
THRUST_HOST_DEVICE void stable_merge_sort_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 first1,
  RandomAccessIterator1 last1,
  RandomAccessIterator2 first2,

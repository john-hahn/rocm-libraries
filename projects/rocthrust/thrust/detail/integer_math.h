...
template <typename Integer>
THRUST_HOST_DEVICE THRUST_FORCEINLINE bool is_odd(Integer x)
{
  return 1 & x;
}

template <typename Integer>
THRUST_HOST_DEVICE THRUST_FORCEINLINE Integer log2(Integer x)
{
...
template <typename Integer>
THRUST_HOST_DEVICE THRUST_FORCEINLINE Integer log2_ri(Integer x)
{
...
THRUST_HOST_DEVICE THRUST_FORCEINLINE
  ...
  // Used to determine # of blocks/warps etc.
  template <typename Integer0, typename Integer1>
  THRUST_HOST_DEVICE THRUST_FORCEINLINE auto divide_rz(Integer0 const x, Integer1 const y)
    THRUST_DECLTYPE_RETURNS(x / y)

  // Round x towards infinity to the next multiple of y.
  template <typename Integer0, typename Integer1>
  THRUST_HOST_DEVICE THRUST_FORCEINLINE auto round_i(Integer0 const x, Integer1 const y)
    THRUST_DECLTYPE_RETURNS(y* divide_ri(x, y))

  // Round x towards 0 to the next multiple of y.
  template <typename Integer0, typename Integer1>
  THRUST_HOST_DEVICE THRUST_FORCEINLINE auto round_z(Integer0 const x, Integer1 const y)

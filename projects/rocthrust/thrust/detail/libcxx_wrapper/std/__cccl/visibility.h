...
#ifndef LIBCXX_WRAPPER__CCCL_VISIBILITY_H
#define LIBCXX_WRAPPER__CCCL_VISIBILITY_H
...
#  include <thrust/detail/libcxx_wrapper/__cccl_config> // _THRUST_STD_INCLUDE(__cccl/visibility.h)
...
#endif // LIBCXX_WRAPPER__CCCL_VISIBILITY_H
